...
public class ExcelUtil{
     ...
     * @param out 输出流
     */
    public static void exportExcel(String title,Map<String, String> headMap,List<Map<String, Object>> list,String datePattern,int colWidth, OutputStream out) {
     ...
     * @param out 输出流
     */
    public static void exportExcelX(String title,Map<String, String> headMap,List<Map<String, Object>> list ,String datePattern,int colWidth, OutputStream out) {
        if(datePattern==null) datePattern = DEFAULT_DATE_PATTERN;
        // 声明一个工作薄
        ...
        headerStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);//设置前景填充样式
        headerStyle.setBorderBottom(HSSFCellStyle.BORDER_THIN);
        headerStyle.setBorderLeft(HSSFCellStyle.BORDER_THIN);
        headerStyle.setBorderRight(HSSFCellStyle.BORDER_THIN);
        headerStyle.setBorderTop(HSSFCellStyle.BORDER_THIN);
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            Map<String, Object> jo = list.get(i);
            SXSSFRow dataRow = sheet.createRow(rowIndex);
            for (int k = 0; k < properties.length; k++)
            {
                SXSSFCell newCell = dataRow.createCell(k);

                Object o =  jo.get(properties[k]);
                String cellValue = "";
                if(o==null) cellValue = "";
                else if(o instanceof Date) cellValue = new SimpleDateFormat(datePattern).format(o);
